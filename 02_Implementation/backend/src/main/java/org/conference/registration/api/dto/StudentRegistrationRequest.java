...
import static org.conference.registration.api.dto.ValidationRules.MSG_STUDENT_ID;
...
import static org.conference.registration.api.dto.ValidationRules.STUDENT_ID;
import static org.conference.registration.api.dto.ValidationRules.STUDENT_ID_MAX;
...
/** Student registration (US-002, FORM_SCHEMA §Student registration). */
public record StudentRegistrationRequest(
    ...
    @NotBlank(message = MSG_REQUIRED)
        @Size(max = STUDENT_ID_MAX, message = MSG_TOO_LONG)
        @Pattern(regexp = STUDENT_ID, message = MSG_STUDENT_ID)
        String studentId,
